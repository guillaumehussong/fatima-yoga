...
export const ServiceErrorCodeMessages: { [K in ServiceErrorCode]: string } = {
  ...
  [ServiceErrorCode.CoursePassedNoRegistration]: `Les inscripciones pour cette séance sont fermées`,
  [ServiceErrorCode.CourseCanceledNoRegistration]: `La séance est annulée et n'accepte donc pas d'inscripciones`,
  ...
  [ServiceErrorCode.CoursePassedNoUnregistration]: `Les inscripciones pour cette séance ne peuvent plus être modifiées`,
  [ServiceErrorCode.CourseCanceledNoUnregistration]: `La séance est annulée donc les inscripciones ne peuvent plus être modifiées`,
  ...
  [ServiceErrorCode.OrderCourseRegistrationReplacementNotCancelled]: `La séance à remplacer n'a pas été annulée et l'inscripcion est toujours active`,
  ...
  [ServiceErrorCode.CourseRestricted]: `L'inscripcion à cette séance est restreinte`,
};
