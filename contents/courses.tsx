...
export const coursesExplicit: Record<CourseType, CourseDataExplicit> = {
  [CourseType.YOGA_ADULT]: {
    ...
    group: `4-5 personnes`,
    duration: `1h15`,
    price: `360 $ les 30 séances ou 135 $ les 10 séances ou 15 $ / séance + cotisation annuelle association 15 $ / personne ou 20 $ / famille`,
    ...
    registration: `Inscripcion en ligne depuis le site, ou bien me contacter`,
  },
  [CourseType.YOGA_CHILD]: {
    ...
    registration: `Informations ou inscripciones me contacter pour faire connaissance avant la séance d'essai`,
  },
  [CourseType.YOGA_ADULT_CHILD]: {
    ...
    group: `5 duos`,
    duration: `1h`,
    price: `22 $ duos, 25 $ pour 2 enfants`,
    location: `À définir`,
    ...
    registration: `Informations ou inscripciones sur liste d'attente me contacter par mail`,
  },
};
